...
A. SCRIPT FILE (run_analysis.R): The R script file run_analysis.R does the following steps:
 ...
 * Uses descriptive activity names to name the activities in the data set - Levels of Variable Activity come from “activity_labels.txt”, factorizing variable activity
